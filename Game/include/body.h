...
/**
 * Returns the body's current orientation in the plane as set by
 * body_set_rotation()
 *
 * @param body whose orientation is returned
 * @return double representing the body's angle
 */
...
/**
 * Returns amount of damage applied to a body
 *
 * @param body to get damage of
 * @return double representing amount of damage to body
 */
double body_damage_collisions(body_t *body);

/**
 * Applies damage to a body
 *
 * @param body to damage
